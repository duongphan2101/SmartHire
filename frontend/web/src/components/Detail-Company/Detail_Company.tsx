...
const Detail_Company: React.FC = () => {
  ...
  const { department, loading, error, getDepartmentById } =
    useDepartment("user");
    ...
    <div className="detail-company-container">
      ...
      <div className="detail-company-body">
        ...
        <div className="company-info-card bg-white rounded-sm shadow-2xl">
          ...
          <div
            className="company-info-bottom text-justify"
            style={{ marginTop: 20 }}
          >
            <p>
              <strong>Địa chỉ:</strong> {department.address || "Chưa cập nhật"}
            </p>
            <p className="flex gap-1.5">
              ...
              <span className="text-gray-500">
                (Dựa trên {displayTotalReviews} reviews)
              </span>
            </p>
            <p className="flex gap-1.5">
              <strong>Website:</strong>{" "}
              <a className="text-blue-500" href={department.website}>
                {department.website || "Chưa cập nhật"}
              </a>
            </p>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {currentJobs.length > 0 ? (
              currentJobs
                ...
                .map((item) => (
                  <div key={item._id} className="lasted-item flex flex-col">
                    ...
                    <div
                      className="lasted-item_bottom gap-2"
                      style={{ marginTop: 10 }}
                    >
              ...
              <p className="text-gray-500">
                Công ty hiện chưa có tin tuyển dụng nào.
              </p>
            )}
          </div>
      ...
      <CompanyReview companyId={department._id} />
      <Footer />
    </div>
  );
};
