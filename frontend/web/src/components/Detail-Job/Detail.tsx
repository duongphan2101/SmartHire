      ...
      <div className="page-title w-full flex flex-col gap-3">
        ...
        <div className="flex items-center justify-between">
          <div className="flex flex-col">
            <span className="text-left title-job flex items-center gap-1.5 flex-wrap">{item.jobTitle}
              <MdReport
                className="reportIcon text-[20px] text-gray-200 hover:text-red-500"
                onClick={() => {
                  if (!user) {
                    window.location.href = "/login";
                    return;
            ...
            <a
              ...
              style={{ fontSize: 18 }}
            >
              <span className="department-item-name hover:text-emerald-700">
              ...
              <div className="col-span-12 md:col-span-5">
                <div className="content-main-right w-full">
                  <div className="item-department w-full">
                    ...
                    <span className="department-item-name">
                      <FaBusinessTime color="green" /> {formattedDate}{" "}
                      {expiryMessage}
                    </span>
