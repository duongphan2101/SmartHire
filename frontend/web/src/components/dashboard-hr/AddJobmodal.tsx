                            ...
                            {jobDescriptions.map((desc, index) => (
                                <div className="add-job-skill-input-wrapper" key={index}>
                                    <div className="add-job-input-container">
                                        ...
                                        />
                                        <label className="add-job-label">{`Mô tả ${index + 1}`}</label>
                                        <div className="add-job-underline"></div>
                                    </div>
                            ...
                            {requirements.map((requirement, index) => (
                                <div className="add-job-skill-input-wrapper" key={index}>
                                    <div className="add-job-input-container">
                                        ...
                                        />
                                        <label className="add-job-label">{`Yêu cầu ${index + 1}`}</label>
                                        <div className="add-job-underline"></div>
                                    </div>
                            ...
                            {skills.map((skill, index) => (
                                <div className="add-job-skill-input-wrapper" key={index}>
                                    <div className="add-job-input-container">
                                        ...
                                        />
                                        <label className="add-job-label">{`Kĩ năng ${index + 1}`}</label>
                                        <div className="add-job-underline"></div>
                                    </div>
                                    {skills.length > 1 && (
                                        <button
                            ...
                            {benefits.map((benefit, index) => (
                                <div className="add-job-skill-input-wrapper" key={index}>
                                    <div className="add-job-input-container">
                                        ...
                                        />
                                        <label className="add-job-label">{`Phúc lợi ${index + 1}`}</label>
                                        <div className="add-job-underline"></div>
                                    </div>
                                    {benefits.length > 1 && (
                                        <button
