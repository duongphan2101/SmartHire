          ...
          <div style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; background: #f8f9fa; padding: 20px; border-radius: 10px;">
            ...
            <div style="background: white; padding: 40px; border-radius: 0 0 10px 10px; box-shadow: 0 4px 6px rgba(0,0,0,0.1);">
              ...
              <div style="background: #f8f9fa; border: 2px solid #e9ecef; border-radius: 10px; padding: 30px; text-align: center; margin: 30px 0;">
                <h1 style="color: #2fba14ff; font-size: 36px; font-weight: bold; margin: 0; letter-spacing: 8px; font-family: 'Courier New', monospace;">${otp}</h1>
              ...
              <div style="text-align: center; margin: 30px 0;">
                <a href="#" style="background: #18c121ff; color: white; padding: 12px 30px; text-decoration: none; border-radius: 6px; font-weight: 500; display: inline-block;">Tiếp tục trên SmartHire</a>
              </div>
              ...
              <p style="color: #6c757d; font-size: 11px; text-align: center; margin: 0;">
                ...
                <a href="#" style="color: #20e34aff; text-decoration: none;">Unsubscribe</a> | 
                <a href="#" style="color: #14cf3fff; text-decoration: none;">Privacy Policy</a>
              </p>
            </div>
          </div>
        `, // html body
